...
public class SiteBuilder {
     ...
     */
    private static String buildBlogPaginator(int page, int totalPages, String absBaseHref) {
        ...
        for (int page = 1; page <= totalPages; page++) {
            ...
            for (BlogPost p : pagePosts) {
                ...
                c.append("  <h2 class=\"blog-card-title\"><a href=\"")
                 .append(escapeHtml(pathToBlog + p.slug())).append("/\">")
                ...
                if (!p.tags().isEmpty()) {
                    ...
                    for (int i = 0; i < p.tags().size(); i++) {
                        ...
                        c.append("<a href=\"").append(escapeHtml(pathToBlog + "tags/" + tagToSlug(tag)))
                ...
                c.append("  <a href=\"").append(escapeHtml(pathToBlog + p.slug()))
            ...
            Files.writeString(out, renderPage(pageTitle, c.toString(), navRoot,
    ...
    private void renderTagPage(String tag, List<BlogPost> posts,
                               SiteNode navRoot, String localePrefix) throws IOException {
            ...
            for (BlogPost p : pagePosts) {
                ...
                if (!p.tags().isEmpty()) {
                    ...
                    for (int i = 0; i < p.tags().size(); i++) {
                        ...
                        c.append("<a href=\"").append(escapeHtml(pathToTags + tagToSlug(t)))
